...
LogoState.prototype._displayMessage = function( surface ) {
  ...
  surface.fillText( 'This is RPG Game Inspired by Touhou', this.opening.getWidth( ) / 2, 200 ) ;
  surface.fillText( 'Presented by Yuma-Tsushima', this.opening.getWidth( ) / 2, 300 ) ;
...
TitleState.prototype._displayMessage = function( surface ) {
  ...
  surface.fillText( 'Touhou RPG Game', 120, 200 ) ;
  surface.restore( ) ;
} ;
